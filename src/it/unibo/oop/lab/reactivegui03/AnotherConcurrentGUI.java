...
public class AnotherConcurrentGUI  extends JFrame {
    ...
    private static final int MAX_EXEC_TIME = 10000;
    ...
    public AnotherConcurrentGUI() {
        ...
        final MaxExec maxexec = new MaxExec();
        new Thread(agent).start();
        new Thread(maxexec).start();
        /*
    ...
    private class MaxExec implements Runnable {
